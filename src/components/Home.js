...
export default function Home() {
  ...
  return (
    <div className="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32 home">
      <img
        src={ headerImage }
        alt=""
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto mt-10 max-w-2xl lg:mx-0 lg:max-w-none">
          <div className="grid grid-cols-1 gap-x-8 gap-y-6 text-base font-semibold leading-7 text-white sm:grid-cols-2 md:flex lg:gap-x-10">
              <p className='home--links' onClick={ () => navigate("/characters" ) }>List of Characters<span aria-hidden="true">&rarr;</span></p>
              <p className='home--links' onClick={ () => navigate("/spells") }>List of spells<span aria-hidden="true">&rarr;</span></p>
              <p className='home--links' onClick={ () => navigate("/quiz") }>Quiz<span aria-hidden="true">&rarr;</span></p>
          </div>
